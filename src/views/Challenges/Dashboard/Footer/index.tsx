import FooterLogo from '@/views/Challenges/Dashboard/Footer/components/Logo.tsx';
import FooterLinks from '@/views/Challenges/Dashboard/Footer/components/Links.tsx';
