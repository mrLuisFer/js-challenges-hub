...
import { validateIsIpAddress } from '../../utils/isIpAddress.ts';
import { useMapStore } from '../../../lib/store/useMapStore.ts';
import { LatLngExpression } from 'leaflet';
import { getIpAddress } from '../../../lib/api/getIpAddress.ts';
...
export default function Form() {
	...
	return (
		<form className="flex h-11 w-80 md:w-auto mx-auto md:m-0" onSubmit={handleSubmitIp}>
			...
			<button className="bg-[hsl(0,_0%,_17%)] w-12 flex items-center justify-center rounded-r-lg filter hover:brightness-95 active:brightness-90 transition">
